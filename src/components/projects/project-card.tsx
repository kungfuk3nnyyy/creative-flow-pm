  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        {project.description && (
          <p className="text-body-sm text-slate line-clamp-2 mb-4">{project.description}</p>
        )}

        {project.clientName && (
          <p className="text-caption text-stone mb-4">Client: {project.clientName}</p>
        )}

        <div className="flex items-center gap-4 text-caption text-stone flex-wrap">
          {project.startDate && (
          ...
          <span
            className={cn(
              ...
              project._count.milestones > 0 && "text-slate",
            )}
          >
          ...
          <span
            className={cn(
              "inline-flex items-center gap-1",
              project._count.expenses > 0 && "text-slate",
            )}
          >
          ...
          <span
            className={cn(
              "inline-flex items-center gap-1",
              project._count.invoices > 0 && "text-slate",
            )}
          >

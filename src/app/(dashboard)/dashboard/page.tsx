...
function formatTrendChange(basisPoints: number, label: string): string {
...
function trendDirection(basisPoints: number, inverted = false): "up" | "down" | "neutral" {
        ...
        {isLoading ? (
          ...
          <>
            ...
            <KPICard
              ...
              change={formatTrendChange(kpis.invoiceTrendBasisPoints, "last month")}
              trend={trendDirection(kpis.invoiceTrendBasisPoints)}
              icon={DollarSign}
            />
            <KPICard
              label="Expenses This Month"
              value={formatCents(kpis.expensesThisMonth)}
              change={formatTrendChange(kpis.expenseTrendBasisPoints, "last month")}
              trend={trendDirection(kpis.expenseTrendBasisPoints, true)}
              icon={Receipt}
            />
            <KPICard
              label="Overdue"
          ...
          <Card>
            ...
            <CardContent>
              {recentActivity.length === 0 ? (
                <p className="text-body-sm text-slate text-center py-6">
                  No recent activity.
                </p>
              ) : (
